...
/**Admin Service**/
Route::get('admin-import', [AdminService\AdminImport\AdminImportController::class, 'index'])->name('admin_import');
Route::post('admin-import/update', [AdminService\AdminImport\AdminImportController::class, 'updateFiles'])->name('admin_import.update');
Route::post('admin-import/pages', [AdminService\AdminImport\AdminImportController::class, 'pageImport'])->name('admin_import.pages');
Route::post('admin-import/refresh', [AdminService\AdminImport\AdminImportController::class, 'refreshFiles'])->name('admin_import.refresh');
