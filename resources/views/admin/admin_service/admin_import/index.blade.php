        ...
        <div class="content-layout content-width-small">
            <div class="content-element">
                ...
                <div>
                    ...
                    <br>
                    <form method="post" action="{{route("admin.admin_import.update")}}">
                        <div hidden>
                            @method('POST')
                            @csrf
                        </div>
    ...
    @if($data->all_pages??false)
        <div class="content-layout content-width-small">
            <div class="content-element">
                ...
                <div>
                    <div>
                        <form method="post" action="{{route("admin.admin_import.pages")}}">
                            @method('POST')
                            @csrf
                            <div class="row js-import-form">
                                <div class="js-ak-data-import"></div>
...
@push('footer_stack_bottom')
    <script>
        ...
        function startImport(data, i, form) {
            ...
            $.ajax({
                url: '{{route("admin.admin_import.pages")}}',
                type: 'post',
        ...
        function refreshFiles(form) {
            ...
            form.find('.js-ak-progress-bar').css('width', progress + '%');
            $.ajax({
                url: '{{route("admin.admin_import.refresh")}}',
                type: 'post',
