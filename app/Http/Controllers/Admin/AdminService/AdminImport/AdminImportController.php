...
class AdminImportController extends Controller
{
    ...
    public function updateFiles(Request $request)
    {
        ...
        if ($dataApi->success) {
            ...
            return redirect(route('admin.admin_import'))->with("message",$dataApi->message??"Error on update.");
        }
        return redirect(route('admin.admin_import'))->with("toast_success", trans('admin/misc.success_confirmation_updated'));
    }
